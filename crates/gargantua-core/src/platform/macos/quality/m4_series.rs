// =============================================================================
// crates/gargantua-core/src/platform/macos/quality/m4_series.rs
// =============================================================================
//
// PURPOSE:
//   Defines the render quality preset for M4 Series chips.
//   Called by quality/mod.rs::from_chip_info() when the chip tier matches.
//   Returns a QualityPreset tuned to the M4 Series's GPU core count,
...
//
// PRESET VALUES (M4 Series):
//   Real-time SPP:      20  (targets 60fps at 1440p)
//   High quality SPP:   32  (targets 30fps at 1440p, or 60fps at 1080p)
//   Max steps:          320   (geodesic integration steps per ray)
//   Max offline SPP:    2048 (offline render ceiling)
//   Workgroup:          (16, 8, 1)
//   TAA enabled:        true
//   Bloom enabled:      true
//   Motion blur:        true
...
//   Example for M4 Series:
//     base gpu_cores → spp = 20
//     higher gpu_cores → spp scales linearly up to 32
//
// NOTES FOR AI:
//   - All SPP values target 60fps at 1440p on the base configuration.
//     At 4K, divide SPP by 4 to maintain the same frame time.
//   - target_fps = 120: used by the render loop to set the frame time budget.
