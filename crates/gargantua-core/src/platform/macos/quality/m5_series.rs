// =============================================================================
// crates/gargantua-core/src/platform/macos/quality/m5_series.rs
// =============================================================================
//
// PURPOSE:
//   Defines the render quality preset for M5 Series chips.
//   Called by quality/mod.rs::from_chip_info() when the chip tier matches.
//   Returns a QualityPreset tuned to the M5 Series's GPU core count,
...
//
// PRESET VALUES (M5 Series):
//   Real-time SPP:      24  (targets 60fps at 1440p)
//   High quality SPP:   40  (targets 30fps at 1440p, or 60fps at 1080p)
//   Max steps:          384   (geodesic integration steps per ray)
//   Max offline SPP:    4096 (offline render ceiling)
//   Workgroup:          (16, 8, 1)
//   TAA enabled:        true
//   Bloom enabled:      true
//   Motion blur:        true
...
//   Example for M5 Series:
//     base gpu_cores → spp = 24
//     higher gpu_cores → spp scales linearly up to 40
//
// NOTES FOR AI:
